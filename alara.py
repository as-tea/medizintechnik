...
# Gesamteffektive Dosisberechnung
dosis_stündlich = (
    basis_dosisrate * faktor_abstand * faktor_schuerze * faktor_wand
)
gesamtdosis = dosis_stündlich * zeit  # in mSv
...
with col3:
    # Risiko-Einordnung
    if gesamtdosis < 1.0:
        st.success("Status: Geringe Exposition (Normalbereich Bevölkerung)")
    elif gesamtdosis < 20.0:
        st.warning("Status: Erhöhte Exposition (Überwachungs-/Kontrollbereich)")
    else:
        st.error("Status: Kritische Dosis! Grenzwert überschritten!")
